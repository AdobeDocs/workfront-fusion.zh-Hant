...
如需詳細資訊，請參閱[Publish和共用 [!DNL Adobe Workfront Fusion templates]](/help/workfront-fusion/create-and-manage-templates/publish-and-share-fusion-templates.md)。

## 如何編輯或刪除公用範本？

**答案**：

檢視[檢視、編輯和刪除 [!DNL Adobe Workfront Fusion] 範本](/help/workfront-fusion/create-and-manage-templates/view-edit-and-delete-fusion-templates.md)。
