...
title: Workfront Fusion 發行活動：2020 年 8 月 17 日當週
...
# Workfront Fusion 發行活動：2020 年 8 月 17 日當週
...
## SharePoint聯結器和模組現已推出

您現在可以使用Workfront Fusion連線至您的SharePoint帳戶。 透過SharePoint模組，您可以在SharePoint帳戶中執行動作，例如建立專案、讀取檔案或下載檔案。
