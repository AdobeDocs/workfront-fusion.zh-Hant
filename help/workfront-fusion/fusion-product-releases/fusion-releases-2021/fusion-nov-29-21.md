---
title: Workfront Fusion發行活動： 2021年11月29日當週
description: Workfront Fusion發行活動： 2021年11月29日當週
author: Luke
draft: Probably
...
現在您可以使用Adobe Workfront Fusion來建立和修改PDF。 由於Workfront Fusion是Adobe產品套裝的一部分，您不需要個別的Adobe帳戶即可使用這些模組。
...
* 將PDF轉換為影像或檔案
* 將PDF檔案合併為一個較大的PDF檔案
* 使用密碼保護PDF檔案的安全，或從PDF移除密碼保護
* 壓縮PDF檔案以使用較少的記憶體或頻寬
* 將PDF檔案線性化，以便在下載整個檔案之前可以逐頁閱讀
* 在檔案上使用光學字元辨識(OCR)
* 透過刪除或旋轉特定頁面來修改PDF
