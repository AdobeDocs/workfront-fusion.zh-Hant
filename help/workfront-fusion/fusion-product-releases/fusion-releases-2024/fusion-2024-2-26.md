...
# Workfront Fusion 發行活動：2024 年 2 月 26 日當週
...
如需Workfront Fusion中函式的一般資訊，請參閱[使用內建函式對應專案](/help/workfront-fusion/create-scenarios/map-data/map-using-functions.md)。
