...
>[!NOTE]
>
>Workfront Fusion有自己的API，您可以使用這些API在Fusion中自動化動作。
>API將以漸進方式發行，目前會標籤為實驗性。 Fusion團隊正積極開發和擴充API，並隨著新功能推出而發佈更新。
...
* **擁有者對應用程式API所做的變更可能會影響Fusion功能。** 如果變更足夠嚴重，Fusion可能需要更新模組或連線型別，或者在極端情況下可能為應用程式建立新的連線器。
