...
[!DNL Adobe Workfront Fusion] Devtool可協助您瞭解並疑難排解案例。 使用Devtool，您可以檢查案例的所有手動執行、檢閱所有已執行的操作，並檢視每個已執行API呼叫的詳細資訊。 您可以檢視導致錯誤的模組、操作或單一回應，並運用該知識來調整您的案例。
...
如果您在AdobeUnified Shell中使用Fusion，或已更新至新的Fusion體驗，則可以從案例編輯器存取Devtool。
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p> 從情境中的變數模組，找出您要取代的變數藥丸，並將其複製到此([!UICONTROL Variable to Find])欄位。 在欄位中，它會顯示為雙大括弧。 範例： <code>&#123;&#123;5.value&#125;&#125;</code>。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Replace With]</p> </td> 
   <td> <p>從情境中的變數模組，找出您要取代變數的變數藥丸，並將其複製到此([!UICONTROL Variable to Find])欄位。 在欄位中，它會顯示為雙大括弧。 範例： <code>&#123;&#123;5.value&#125;&#125;</code>。</p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto">
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>選取您要將資料從[!UICONTROL Raw Data]欄位編碼為Base64，還是要將Base64解碼為原始資料。</p> </td> 
  </tr> 
  <tr> 
