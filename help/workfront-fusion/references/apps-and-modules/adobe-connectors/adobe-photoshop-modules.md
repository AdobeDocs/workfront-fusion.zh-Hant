...
1. 填寫下列欄位：
   ...
   <table style="table-layout:auto"> 
      ...
      <tbody>
        ...
        <td>輸入您的[!DNL Adobe] [!UICONTROL Technical account ID]。 您可在[!UICONTROL Credentials]詳細資料區段的 [!DNL Adobe Developer Console]</td>
        </tr>
        <tr>
        <td role="rowheader">[!UICONTROL Organization ID]</td>
        <td>輸入您的[!DNL Adobe] [!UICONTROL Organization ID]。 您可在[!UICONTROL Credentials]詳細資料區段的 [!DNL Adobe Developer Console]</td>
        </tr>
        <tr>
