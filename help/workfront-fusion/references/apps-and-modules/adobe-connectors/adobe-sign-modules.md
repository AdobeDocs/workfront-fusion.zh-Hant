...
description: 透過 [!DNL Adobe Acrobat Sign] 模組，您可以根據您 [!DNL Adobe Workfront Fusion] Acrobat Sign帳戶中的事件來啟動 [!DNL Adobe] 案例、建立、讀取或更新合約及其他記錄、使用您設定的條件搜尋記錄，以及上傳檔案。
author: Becky
...
透過[!DNL Adobe Acrobat Sign]模組，您可以根據[!DNL Adobe Workfront Fusion]帳戶中的事件來啟動[!DNL Adobe Acrobat Sign]案例、建立、讀取或更新合約及其他記錄、使用您設定的條件搜尋記錄，以及上傳檔案。
