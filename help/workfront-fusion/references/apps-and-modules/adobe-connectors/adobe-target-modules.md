...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      <td role="rowheader">[!UICONTROL Options]</td>
      <td>
        <p>針對您想要新增至活動的每個選項，按一下「<b>[!UICONTROL Add item]</b>」並填寫下列欄位：</p>
        <ul>
          <li>
            <p><b>[!UICONTROL Option local ID]</b>
            </p>
    ...
    <tr>
      ...
      <td>
        <p>針對您想要新增至活動的每個Mbox，按一下「<b>[!UICONTROL Add item]</b>」並填寫下列欄位：</p>
        <ul>
          <li>
            <p>[!UICONTROL Audience IDs]</p>
            <p>針對您想要新增至Mbox的每個對象，按一下「<b>[!UICONTROL Add item]</b>」並選取對象ID。</p>
          </li>
          <li>
            <p><b>[!UICONTROL Location local ID]</b>
            </p>
      ...
      <td>
        ...
        <ul>
          ...
          <li>
            ...
            <p>針對您想要檢視體驗的每個對象，按一下「<b>[!UICONTROL Add item]</b>」並輸入對象ID。
    ...
    <tr>
      <td role="rowheader">[!UICONTROL Property IDs] </td>
      <td>針對您想要新增至活動的每個屬性，按一下「<b>[!UICONTROL Add item]</b>」並選取或對應屬性的ID。</td>
    </tr>
    <tr>
      <td role="rowheader">[!UICONTROL Reporting audiences]</td>
      <td>
        <p>針對您想要新增至活動的每個報表對象，按一下「[!UICONTROL Add item]」並輸入下列資訊：</p>
        <ul>
          <li>
            <p><b>[!UICONTROL Reporting Audience local ID]</b>
            </p>
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>針對您要排序的每個欄位，按一下<b>[!UICONTROL Add item]</b>並選取欄位，以及傳回的結果應該遞增還是遞減。</td>
    </tr>
    <tr>
      <td role="rowheader">[!UICONTROL Starts At]</td>
      <td>
...
<tbody>
  ...
  <tr>
    ...
    <td>
      <p>輸入您希望模組傳回的第一個回應編號。 第一個傳回回回的回應有<code>0</code>的位移。 將此欄位與[!UICONTROL Maximum number of returned results]欄位搭配使用，將回應分頁。</p>
      <p>例如，若要檢視回應的第三個頁面，當每個頁面有10個回應時，請將[!UICONTROL Offset]設為20，並將[!UICONTROL Maximum number of returned]個結果設為10。</p>
    </td>
  </tr>
  <tr>
    <td role="rowheader">[!UICONTROL Limit]</td>
    <td>
      <p>輸入或對應您希望模組在每個案例執行週期中傳回的最大記錄數。 將此欄位與[!UICONTROL Offset]欄位搭配使用，將回應分頁。</p>
      <p>例如，若要檢視回應的第三個頁面，當每個頁面有10個回應時，請將[!UICONTROL Offset]設為20，並將[!UICONTROL Maximum number of returned]個結果設為10。</p>
    </td>
  </tr>
</tbody>
