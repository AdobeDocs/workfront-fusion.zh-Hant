...
description: '[!DNL Adobe Workfront Fusion Frame].io模組可讓您監視、建立、更新、擷取或刪除您[!DNL Frame.io]帳戶中的資產和註解。'
author: Becky
...
>[!IMPORTANT]
>
>本文說明Frame.io聯結器的舊版。 此連接器用於連接至 Frame.io 版本 3。
>
>如需新（測試版）版Frame.io聯結器的說明，請參閱[Frame.io聯結器](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/frame-io-modules-new.md)。
...
如需新版Frame.io聯結器的說明，請參閱[Frame.io聯結器](/help/workfront-fusion/references/apps-and-modules/adobe-connectors/frame-io-modules-new.md)。
