...
1. 在任何[!DNL Adobe Workfront Planning]模組中，按一下[連線]方塊旁的&#x200B;**[!UICONTROL Add]**。
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>選取您要觀看舊狀態還是新狀態。<ul><li><p><b>[!UICONTROL New state]</b></p><p>當記錄將指定值<b>變更為</b>時觸發案例。</p></li><li><p><b>[!UICONTROL Old state]</b></p><p>當記錄從</b>變更指定值時，觸發案例<b>。</p></li></ul></td> 
    <tr>
