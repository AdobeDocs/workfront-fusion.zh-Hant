...
description: 透過[!DNL Adobe Workfront Planning]模組，您可以根據[!DNL Adobe] Adobe Workfront Planning帳戶中的事件來啟動Workfront Fusion案例、建立、讀取或更新協定和其他記錄、使用您設定的條件搜尋記錄以及上傳檔案。
author: Becky
...
<table style="table-layout:auto"> 
  ...
  <tbody>
    ...
    <tr>
      <td role="rowheader">[！UICONTROL啟用安全鉤點]</td>
      <td>
    ...
    <tr>
      <td role="rowheader">[！UICONTROL自訂權杖]</td>
      <td>
