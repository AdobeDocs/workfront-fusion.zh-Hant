...
在 Adobe Workfront Fusion 情境中，您可以將使用 [!DNL Anaplan] 的工作流程自動化，以及將其連接至多個第三方應用程式和服務。
...
## 將 [!DNL Anaplan] 連接至 Workfront Fusion {#connect-anaplan-to-workfront-fusion}
  ...
  <tr> 
   ...
   <td> <p>選取要讀取的記錄型別。</p> 
    <ul> 
     ...
     <li> <p><b>工作區</b> </p> <p>選取或對應您要讀取之Workspace的ID。</p> </li> 
