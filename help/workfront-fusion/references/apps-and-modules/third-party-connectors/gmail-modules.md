  ...
  <tr> 
   ...
   <td> <p>選取您要用來觀看電子郵件的篩選型別</p> 
    <ul> 
     ...
     <li> <p> <strong>[！UICONTROL Gmail篩選器]</strong> </p> <p>在[！UICONTROL查詢]欄位中，輸入您要用來篩選電子郵件的查詢。</p> <p>如需[!DNL Gmail]篩選器的詳細資訊，請參閱<a href="https://support.google.com/mail/answer/7190">檔案中的</a>進階搜尋[!DNL Gmail]。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td>[！UICONTROL條件]</td> 
