...
在 Adobe Workfront Fusion 情境中，您可以將使用 [!DNL Gmail] 的工作流程自動化，以及將其連接至多個第三方應用程式和服務。
...
若要使用 [!DNL Gmail] 模組，您必須擁有 [!DNL Gmail] 帳戶。

## 將 [!DNL Gmail] 連接至 Workfront Fusion {#connect-gmail-to-workfront-fusion}

* [使用 [!DNL Google Workspace]連線 [!DNL Gmail] 至Workfront Fusion](#connect-gmail-to-workfront-fusion-usinggoogle-workspace)
* [使用 [!DNL gmail.com] 或 [!DNL googlemail].com連線 [!DNL Gmail] 至Workfront Fusion](#connect-gmail-to-workfront-fusion-using-gmailcom-or-googlemailcom)

### 使用[!DNL &#x200B; Google Workspace]連線[!DNL Gmail]至Workfront Fusion
...
### 使用[!DNL gmail.com]或[!DNL googlemail].com連線[!DNL Gmail]至Workfront Fusion
...
當您設定 [!DNL Gmail] 模組時，Workfront Fusion 會顯示下列欄位。 除了這些欄位以外，也可能因為其他因素，例如您在應用程式或服務中的存取層級，而顯示其他 [!DNL Gmail] 欄位。 在模組中，粗體標題表示那是必要欄位。
...
模組會傳回與記錄相關聯的所有標準欄位，以及連線存取的任何自訂欄位和值。 您可以在情境內之後的模組中對應此資訊。
...
模組會傳回電子郵件的ID及任何關聯欄位，以及連線存取的任何自訂欄位和值。 您可以在情境內之後的模組中對應此資訊。
...
模組會傳回電子郵件草稿的ID及任何關聯欄位，以及連線存取的任何自訂欄位和值。 您可以在情境內之後的模組中對應此資訊。
