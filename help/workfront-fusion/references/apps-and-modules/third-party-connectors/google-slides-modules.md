...
若要使用 [!DNL Google Slides] 模組，您必須擁有 [!DNL Google] 帳戶。
...
當您設定 [!DNL Google Slides] 模組時，Workfront Fusion 會顯示下列欄位。 除了這些欄位以外，也可能因為其他因素，例如您在應用程式或服務中的存取層級，而顯示其他 [!DNL Google Slides] 欄位。 在模組中，粗體標題表示那是必要欄位。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>輸入相對於 <code>https://developers.google.com/slides/</code> 的路徑。 E.g. 簡報。</p> <p>如需可用端點的清單，請參閱<a href="https://developers.google.com/slides/reference/rest">[!DNL Google Slides] API檔案</a>。</p> </td> 
  </tr> 
  <tr> 
