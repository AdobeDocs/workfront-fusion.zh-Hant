  ...
  <tr> 
   ...
   <td> <p>選取您要如何篩選搜尋</p> 
    <ul> 
     ...
     <li> <p><strong>[!UICONTROL Properties]</strong> </p> <p>輸入搜尋的群組或篩選器。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>如果要排序結果，請按一下。 如果您選擇排序結果，則會顯示下列欄位。 </p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Property name]</strong> </p> <p>選取您要用來排序結果的屬性</p> </li> 
     <li> <p><strong>[!UICONTROL Direction]</strong> </p> <p>選擇您要以遞增或遞減方向排序結果。</p> </li> 
    </ul> </td> 
  </tr> 
   <tr> 
  ...
  <tr> 
   ...
   <td> <p>選取要如何識別要新增至清單的連絡人：</p> 
    <ul> 
     ...
     <li> <p>[!UICONTROL Emails]</p> <p>新增您要新增至清單的連絡人電子郵件地址。</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>新增批次連絡人。</p> <p>按一下<strong>[!UICONTROL Add item]</strong>以新增連絡人。 在出現的視窗中，輸入或對應下列資訊：</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Search Type]</strong> </p> <p>選取您要如何識別連絡人：</p> 
      <ul> 
       <li> <p>[!UICONTROL ID]</p> <p>輸入要建立或更新之連絡人的識別碼。 </p> </li> 
       <li> <p>[!UICONTROL Email]</p> <p>輸入您要建立或更新之連絡人的電子郵件地址。 </p> </li> 
      </ul> </li> 
     <li> <p><strong>[!UICONTROL Properties]</strong> </p> <p>填寫您要設定或更新連絡人的任何屬性。</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
>
>在[!UICONTROL Bundle] > [!UICONTROL Body] > [!UICONTROL contacts]下模組的輸出中找到搜尋的相符專案。
>
>在我們的範例中，傳回3個連絡人：
>
...
1. 選取&#x200B;**[!UICONTROL Create an App]**&#x200B;選項。
1. 輸入應用程式名稱並[!UICONTROL Save]對話方塊。
1. 選取您的webhook所需的範圍。

   例如，新增連絡人範圍，以便在建立或刪除新連絡人時觸發模組。

   [!UICONTROL contacts scope]是您接收連絡人、交易和公司活動Webhook所需的一切。

   >[!IMPORTANT]
   >
   >請勿填寫[!UICONTROL Redirect URL]欄位。
