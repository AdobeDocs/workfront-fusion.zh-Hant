---
title: Jira軟體模組
description: 在Adobe Workfront Fusion案例中，您可以自動執行使用[!DNL Jira]軟體的工作流程，以及將其連線到多個協力廠商應用程式和服務。
author: Becky
...
在 Adobe Workfront Fusion 情境中，您可以將使用 [!DNL Jira Software] 的工作流程自動化，以及將其連接至多個第三方應用程式和服務。
...
## 將 [!DNL Jira Software] 連接至 Workfront Fusion
...
### 將 [!DNL Jira Cloud] 連接至 Workfront Fusion
...
### 將 [!DNL Jira Server] 連接至 Workfront Fusion
...
1. 按一下「**[!UICONTROL 繼續]**」。
1. 繼續在Workfront Fusion](#create-a-connection-to-jira-server-or-jira-data-center-in-workfront-fusion)中[建立與 [!DNL Jira Server] 或 [!DNL Jira Data Center] 的連線
