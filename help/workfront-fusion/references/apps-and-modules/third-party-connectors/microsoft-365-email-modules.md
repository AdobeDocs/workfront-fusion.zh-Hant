...
description: 在Adobe Workfront Fusion案例中，您可以自動化使用Microsoft Office 365電子郵件的工作流程，並將其連線到多個第三方應用程式和服務。
author: Becky
...
在Adobe Workfront Fusion情境中，您可以自動執行使用[!UICONTROL Microsoft Office 365電子郵件]的工作流程，並將其連線至多個協力廠商應用程式和服務。
...
若要使用 [!DNL Microsoft Office 365 Email] 模組，您必須擁有 [!DNL Microsoft Office 365 Email] 帳戶。
...
## 正在將[!DNL Office 365 Email]服務連線到Workfront Fusion
...
當您設定 [!DNL Microsoft Office 365 Email] 模組時，Workfront Fusion 會顯示下列欄位。 除了這些欄位以外，也可能因為其他因素，例如您在應用程式或服務中的存取層級，而顯示其他 [!DNL Microsoft Office 365 Email] 欄位。 在模組中，粗體標題表示那是必要欄位。
  ...
  <tr> 
   ...
   <td> <p>針對您想要傳送電子郵件的每個收件者，按一下[新增專案] <b>並輸入下列內容：</b></p> 
    <ul> 
     ...
     <li> <p><strong>[！UICONTROL名稱]</strong> </p> <p>輸入連絡人的名稱。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>針對您想要新增至電子郵件的每個標題，按一下<b>新增專案</b>並輸入下列內容：</p> 
    <ul> 
     ...
     <li> <p><strong>[！UICONTROL值]</strong> </p> <p>輸入頁首的值。</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
