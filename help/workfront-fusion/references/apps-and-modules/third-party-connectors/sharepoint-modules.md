...
您可以使用您的[!DNL Microsoft]帳戶來建立與[!DNL SharePoint]的連線。 如需有關將您的[!DNL Sharepoint]帳戶連線到[!DNL Workfront Fusion]的指示，請參閱[建立連線到 [!DNL Adobe Workfront Fusion]  — 基本指示](/help/workfront-fusion/create-scenarios/connect-to-apps/connect-to-fusion-general.md)
...
1. 按一下&#x200B;**[!DNL SharePoint]**&#x200B;方塊頂端附近的&#x200B;**[!UICONTROL Add]**&#x200B;以開啟&#x200B;**[!UICONTROL Create a connection]**&#x200B;方塊。

1. （選用）變更預設&#x200B;**[!UICONTROL Connection name]**。
1. 按一下&#x200B;**[!UICONTROL Show advanced settings]**。
1. 輸入[!DNL SharePoint] **[!UICONTROL Client ID]**&#x200B;和&#x200B;**[!UICONTROL Client Secret]**。
  ...
  <tr> 
   ...
   <td> <p>選取您要如何識別要擷取變更的資料夾位置。</p> 
    <ul> 
     ...
     <li> <p><strong>[!UICONTROL Select from the list that you follow]</strong> </p> <p>選取您要擷取變更的位置。 </p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要如何識別要取得之檔案的位置。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在出現的欄位中輸入或對映<strong>[!UICONTROL Site ID]</strong>、<strong>[!UICONTROL List ID]</strong>和<strong>[!UICONTROL File ID]</strong>。</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要如何識別網站以及包含您要複製之專案的清單。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在出現的欄位中輸入或對映<strong>[!UICONTROL Site ID]</strong>、<strong>[!UICONTROL List ID]</strong>和<strong>[!UICONTROL Item ID]</strong>。</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要如何識別網站及要建立專案的清單。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在出現的欄位中輸入或對映<strong>[!UICONTROL Site ID]</strong>和<strong>[!UICONTROL List ID]</strong>。</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>針對您想要為新清單設定的每個資料行，輸入欄位的<strong>[!UICONTROL Name]</strong>，並選取您想要新資料行擁有的值<strong>[!UICONTROL Type]</strong>。</td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要如何識別網站以及包含您要取得之專案的清單。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在出現的欄位中輸入或對映<strong>[!UICONTROL Site ID]</strong>和<strong>清單ID</strong>。</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取您要如何識別要觀看的網站和清單。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>輸入或對應您要觀看之清單所在的<strong>[!UICONTROL Site ID]</strong>。</p> </li> 
