...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>輸入（對應）管道ID。</p> <p>注意：可以使用[!UICONTROL List Channels]模組擷取管道識別碼。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Message ID (Time stamp)]</p> </td> 
   <td> <p> 輸入或對應您要擷取相關資訊之訊息的訊息時間戳記。</p> <p>注意：可使用其他模組（例如[!UICONTROL Watch Public Channel]模組）擷取時間戳記。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>輸入或對應管道ID。</p> <p>注意：可以使用[!UICONTROL List Channels]模組擷取管道識別碼。</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選擇您要如何選取要建立訊息的頻道。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Channel ID or name]</strong>欄位中，輸入或對應您要張貼訊息之頻道的頻道識別碼或名稱。</p> <p>注意：可以使用[!UICONTROL List Channels]模組擷取管道識別碼。</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>選取管道型別，然後選取管道。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>如果同時套用下列兩項，請選取<strong>[!UICONTROL Yes]</strong>：</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>啟用此選項以允許自動剖析。 </p> <p>如需詳細資訊，請參閱[!DNL Slack]檔案中的<a href="https://api.slack.com/docs/formatting">格式化應用程式介面的文字</a>。</p> <p>注意：如果您在原始郵件中使用[!UICONTROL Link names]或[!UICONTROL Parse message text]選項，您也應該在執行[!UICONTROL Update a Message]模組時指定這些選項。</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選擇您希望如何選取所要的訊息。</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>在<strong>[!UICONTROL Channel ID or name]</strong>欄位中，輸入或對應頻道識別碼或包含訊息的頻道，然後輸入訊息的<strong>[!UICONTROL Time Stamp (Message ID)]</strong>。.</p> <p>注意：可以使用[!UICONTROL List Channels]模組擷取管道識別碼。</p> </li> 
     <li> <p><strong>[!UICONTROL Select from the list]</strong> </p> <p>選取管道型別，然後選取管道，再選取訊息。</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Text]</p> </td> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Parse message text]</p> </td> 
   <td> <p>啟用此選項以允許自動剖析。 </p> <p> 如需詳細資訊，請參閱[!DNL Slack]檔案中的<a href="https://api.slack.com/docs/formatting">格式化應用程式介面的文字</a>。</p> <p>注意：如果您在原始郵件中使用[!UICONTROL Link names]或[!UICONTROL Parse message text]選項，您也應在執行[更新郵件]模組時指定這些選項。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>選取[!UICONTROL Yes]以在結果中排除已封存的管道。</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Type] </td> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Channel ID]</p> </td> 
   <td> <p>輸入或對應您要擷取相關資訊之管道的ID。</p> <p>注意：可以使用[!UICONTROL List Channels]模組擷取管道識別碼。</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* **私人頻道**：先前為[!UICONTROL Group]
* **直接訊息**：先前為[!UICONTROL IM]
* **頻道**： API檔案中的[!UICONTROL Conversation]，[!DNL Slack]應用程式中的[!UICONTROL channel]。
