 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>在兩種卡片老化模式之間選取。 </p> 
    <ul> 
     <li><strong>[!UICONTROL Pirate mode]</strong>：卡片隨著年齡增長，會撕裂、變黃和裂開，就像舊版海盜地圖一樣。</li> 
     <li><strong>[!UICONTROL Regular mode ]</strong>：卡片隨著年齡的增長而逐漸增加透明度。 </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> 選取您要如何輸入要新增附件的卡片ID。</p> 
    <ul> 
     <li> <p><strong>手動輸入</strong> </p> <p>在<strong>[!UICONTROL Card ID]</strong>欄位中，輸入或對應您要新增附件的卡片識別碼。<br></p> </li> 
