...
如需詳細資訊，請參閱[項目資料類型](/help/workfront-fusion/references/mapping-panel/data-types/item-data-types.md)。
...
1. 按一下[!UICONTROL 資料結構]欄位旁的<strong>[!UICONTROL 新增]</strong>按鈕，以建立新的資料結構。
