...
>[!NOTE]
>
>當您嘗試以相同名稱新增已在資料存放區中的記錄時，模組擲回錯誤，且[!UICONTROL Overwrite an existing record]選項已停用。
...
<table style="table-layout:auto">
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p style="font-weight: normal;">針對您要排序的每個欄位，填寫以下欄位：</p> <p style="font-weight: bold;">[!UICONTROL Key]</p> <p>選取要作為結果排序依據的欄名稱。</p> <p style="font-weight: bold;">[!UICONTROL Order]</p> <p>選取您要以遞增或遞減順序排序結果。</p> </td> 
  </tr> 
  <tr> 
