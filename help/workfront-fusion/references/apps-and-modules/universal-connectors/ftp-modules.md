...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>如需建立與FTP帳戶連線的指示，請參閱本文的FTP模組</a>中的<a href="#create-a-connection" class="MCXref xref">[!UICONTROL 建立連線]。</p> </td> 
  </tr> 
  <tr> 
...
<table>
   ...
   <tbody>
         <tr>
            <td>[!UICONTROL Connection]</td>
            <td>如需建立與FTP帳戶連線的指示，請參閱本文的FTP模組</a>中的<a href="#Create" class="MCXref xref" >[!UICONTROL 建立連線]。</td>
         </tr>
         <tr>
