...
當您設定[!UICONTROL HTTP] > [!UICONTROL 發出基本授權要求]模組時，Adobe Workfront Fusion會顯示下列欄位。 在模組中，粗體標題表示那是必要欄位。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>選取包含您基本驗證認證的金鑰，或按一下<strong>[!UICONTROL 新增]</strong>，將您的認證新增至新的金鑰。 </p> <p>注意：您可以新增更多認證，以輕鬆地在每個連線之間切換。</p> </td> 
  </tr> 
  <tr> 
