...
description: 此Adobe Workfront Fusion動作模組會傳送HTTPS要求至需要API金鑰驗證授權的指定URL，並處理回應。
author: Becky
...
當您設定[!UICONTROL HTTP] > [!UICONTROL 發出API金鑰授權請求]模組時，Adobe Workfront Fusion會顯示下列欄位。 在模組中，粗體標題表示那是必要欄位。
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>選取包含您的API金鑰驗證認證的金鑰。 若要新增金鑰，請按一下<strong>[！UICONTROL新增]</strong>，並設定下列資訊：</p> 
    <ul> 
     <li> <p><strong>[！UICONTROL金鑰名稱]</strong></p> <p>輸入這組API認證的名稱。</p> </li> 
     <li> <p><strong>[！UICONTROL索引鍵]</strong> </p> <p>輸入API金鑰。</p> </li> 
